...
const N_THRESHOLD = 130; // kg â€” agronomic cutoff for high nitrogen
    ...
    <div className="space-y-4">
      ...
      <DataTable<YieldRecord>
        ...
        columns={[
          ...
          { header: "Yield (t/ha)", align: "right", accessor: (r) => r.yield || "â€“" },
          { header: "TNA (kg)", align: "right", accessor: (r) => r.tna || "â€“" },
        ]}
      />

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="glass-card-master p-5">
          <h3 className="text-[15px] font-semibold mb-3" style={{ color: "var(--ink)" }}>Leaderboard â€” High Productivity Farmers</h3>
